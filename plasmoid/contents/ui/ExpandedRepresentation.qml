...
PlasmaExtras.Representation {
    ...
    MultiPointTouchArea {
        ...
        Item { // Album Art + Details
            ...
            // KanvasPlayer: Canvas video, shown on top of the album art
            // whenever kanvasd has one ready for the current track. Falls
            // back to the album art underneath when it doesn't (hasVideo
            // false), so no change is needed to AlbumArtStackView itself.
            CanvasVideoView {
                id: canvasVideo
